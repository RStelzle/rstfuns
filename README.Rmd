...
![This is a Picture of the formula used to calculate Attinas Index of Agreement](img/attina_formula.gif)
...
![This is a Picture of the formula used to calculate the Rice index](img/rice_formula.gif)
